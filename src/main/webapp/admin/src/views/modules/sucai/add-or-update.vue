               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="素材类型" prop="sucaiTypes">
                        <el-select v-model="ruleForm.sucaiTypes" :disabled="ro.sucaiTypes" placeholder="请选择素材类型">
                            <el-option
                ...
                <el-col :span="24">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.sucaiFile" label="素材文件" prop="sucaiFile">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.sucaiFile || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="素材介绍" prop="sucaiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.sucaiContent" label="素材介绍" prop="sucaiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   sucaiContent: [
                              { required: true, message: '素材介绍不能为空', trigger: 'blur' },
                          ],
                   sucaiDelete: [
