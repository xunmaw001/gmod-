...
public class SucaiCollectionView extends SucaiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String sucaiCollectionValue;
	...
	public SucaiCollectionView() {

	}

	public SucaiCollectionView(SucaiCollectionEntity sucaiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, sucaiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getSucaiCollectionValue() {
				return sucaiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setSucaiCollectionValue(String sucaiCollectionValue) {
				this.sucaiCollectionValue = sucaiCollectionValue;
			}
