...
public class SucaiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public SucaiCollectionEntity() {

	}

	public SucaiCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "SucaiCollection{" +
            "id=" + id +
            ", sucaiId=" + sucaiId +
            ", yonghuId=" + yonghuId +
            ", sucaiCollectionTypes=" + sucaiCollectionTypes +
